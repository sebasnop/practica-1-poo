...
public class FixtureGenerator {
    ...
    public List<List<Fixture>> getFixtures(Liga liga, boolean includeReverseFixtures) {

    	List<EquipoFutbol> teams = liga.getEquipos();
        ...
        for (int roundNumber = 0; roundNumber < rounds.size(); roundNumber++) {
            if (roundNumber % 2 == 1) {
                ...
                rounds.get(roundNumber).set(0, new Fixture(fixture.getEquipoVisitante(), fixture.getEquipoLocal()));
            }
        }
        ...
        if(includeReverseFixtures){
            ...
            for(List<Fixture> round: rounds){
                ...
                for(Fixture fixture: round){
                    reverseRound.add(new Fixture(fixture.getEquipoVisitante(), fixture.getEquipoLocal()));
                }
